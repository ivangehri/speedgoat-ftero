...
MODEL           = Analog_Solution
MODULES         = rt_matrx.c rt_printf.c Analog_Solution_capi.c Analog_Solution_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = Analog_Solution.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Ivan\DOCUME~1\GitHub\SPEEDG~1\FORFTE~1
S_FUNCTIONS     = adnipcim.c danipcim.c dinipcim.c donipcim.c fiforead.c fiforeadhdr.c fifowrite.c filterqua.c iqueryqua.c pfidinipcim.c pfidonipcim.c serreadqua.c sertxenable.c serwritequa.c setupqua.c xpcwalltime.c xpcionim.c quatechinit.c
S_FUNCTIONS_LIB = 
NUMST           = 4
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = Analog_Solutionlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Analog_Solution_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Analog_Solution_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Software
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(START_DIR)\Software\WallTime}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\rtw\c\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
...
{$(START_DIR)\Software\WallTime}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
