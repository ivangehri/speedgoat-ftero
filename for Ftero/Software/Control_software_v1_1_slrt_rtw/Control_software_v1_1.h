...
typedef struct {
  ...
  real_T Switch5;                      /* '<S89>/Switch5' */
  real_T Switch7;                      /* '<S89>/Switch7' */
  real_T Delay_k;                      /* '<S88>/Delay' */
  real_T AI_Joy_W;                     /* '<S14>/PCI-6221 AD' */
  real_T AI_Joy_S;                     /* '<S14>/PCI-6221 AD' */
  real_T AI_mot_slide_pos;             /* '<S14>/PCI-6221 AD' */
  ...
  real_T Switch1;                      /* '<S91>/Switch1' */
  real_T Delay_c;                      /* '<S92>/Delay' */
  real_T Sum;                          /* '<S92>/Sum' */
  real_T Switch1_i;                    /* '<S92>/Switch1' */
  real_T Delay1_h;                     /* '<S92>/Delay1' */
  real_T Sum1_l;                       /* '<S92>/Sum1' */
  real_T Sum2;                         /* '<S8>/Sum2' */
  real_T Delay2;                       /* '<S89>/Delay2' */
  real_T Switch4;                      /* '<S89>/Switch4' */
  real_T Switch;                       /* '<S89>/Switch' */
  real_T Switch1_i3;                   /* '<S8>/Switch1' */
  real_T Delay_kl;                     /* '<S90>/Delay' */
  real_T Sum_m;                        /* '<S90>/Sum' */
  real_T Switch1_d;                    /* '<S90>/Switch1' */
  real_T Delay1_j;                     /* '<S90>/Delay1' */
  real_T Sum1_e;                       /* '<S90>/Sum1' */
  real_T Umrechnung1;                  /* '<S7>/Umrechnung1' */
  real_T SpoolingPosSoll;              /* '<S7>/Umrechnung' */
  real_T Switch_b;                     /* '<S7>/Switch' */
  real_T AO_WinchDriver;               /* '<S5>/Saturation1' */
  real_T Gain1_h;                      /* '<S7>/Gain1' */
  ...
  real_T SpoolingPosSoll_o;            /* '<S6>/Umrechnung' */
  real_T Switch3;                      /* '<S6>/Switch3' */
  real_T Switch_l;                     /* '<S6>/Switch' */
  real_T Switch2;                      /* '<S6>/Switch2' */
  real_T Gain_fi;                      /* '<S90>/Gain' */
  real_T Switch_c;                     /* '<S90>/Switch' */
  real_T Switch1_p;                    /* '<S89>/Switch1' */
  real_T Switch3_b;                    /* '<S89>/Switch3' */
  real_T Switch2_n;                    /* '<S89>/Switch2' */
  real_T Switch6;                      /* '<S89>/Switch6' */
  real_T Gain_mu;                      /* '<S92>/Gain' */
  real_T Switch_d;                     /* '<S92>/Switch' */
  real_T Gain_mz;                      /* '<S91>/Gain' */
  real_T Sum1_k;                       /* '<S91>/Sum1' */
  real_T Switch_k;                     /* '<S91>/Switch' */
  real_T Sum_my;                       /* '<S91>/Sum' */
  real_T Switch1_o;                    /* '<S87>/Switch1' */
  real_T Gain_j;                       /* '<S87>/Gain' */
  real_T Sum1_j;                       /* '<S87>/Sum1' */
  real_T Switch_h;                     /* '<S87>/Switch' */
  real_T Sum_no;                       /* '<S87>/Sum' */
  ...
  uint8_T Switch_g;                    /* '<S5>/Switch' */
  uint8_T BytePack;                    /* '<S5>/Byte Pack' */
  uint8_T PNMReceive;                  /* '<S5>/PNM Receive' */
  uint8_T ByteUnpack1;                 /* '<S5>/Byte Unpack1' */
  ...
  boolean_T Compare_m;                 /* '<S96>/Compare' */
  ...
  boolean_T Compare_k;                 /* '<S95>/Compare' */
  boolean_T Compare_b;                 /* '<S93>/Compare' */
  boolean_T RelationalOperator_a;      /* '<S91>/Relational Operator' */
  boolean_T RelationalOperator1_b;     /* '<S87>/Relational Operator1' */
  boolean_T RelationalOperator_j;      /* '<S87>/Relational Operator' */
  boolean_T LogicalOperator2;          /* '<S89>/Logical Operator2' */
  boolean_T LogicalOperator3;          /* '<S89>/Logical Operator3' */
  boolean_T LogicalOperator4;          /* '<S89>/Logical Operator4' */
  boolean_T LogicalOperator5;          /* '<S89>/Logical Operator5' */
  boolean_T LogicalOperator;           /* '<S89>/Logical Operator' */
  boolean_T LogicalOperator1;          /* '<S89>/Logical Operator1' */
  boolean_T LogicalOperator6;          /* '<S89>/Logical Operator6' */
  boolean_T LogicalOperator7;          /* '<S89>/Logical Operator7' */
  ...
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction3_a;/* '<S38>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction1_p;/* '<S38>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction_f;/* '<S38>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction3_p;/* '<S37>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction1_i;/* '<S37>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction_d;/* '<S37>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction4;/* '<S36>/Embedded MATLAB Function4' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction3;/* '<S36>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction1;/* '<S36>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction_g;/* '<S36>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction3_n;/* '<S35>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction1_d;/* '<S35>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction_j;/* '<S35>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction_Co_l_T sf_EmbeddedMATLABFunction2_g;/* '<S34>/Embedded MATLAB Function2' */
  B_EmbeddedMATLABFunction_Co_l_T sf_EmbeddedMATLABFunction1_a;/* '<S34>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Co_l_T sf_EmbeddedMATLABFunction_k;/* '<S34>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction2_m;/* '<S33>/Embedded MATLAB Function2' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction4_g;/* '<S32>/Embedded MATLAB Function4' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction3_o;/* '<S32>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction2_n;/* '<S32>/Embedded MATLAB Function2' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction1_n;/* '<S32>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction3_pw;/* '<S31>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction2;/* '<S31>/Embedded MATLAB Function2' */
  B_EmbeddedMATLABFunction1_C_k_T sf_EmbeddedMATLABFunction1_g;/* '<S31>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Cont_T sf_EmbeddedMATLABFunction_bf;/* '<S30>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction6;/* '<S29>/Embedded MATLAB Function6' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction5;/* '<S29>/Embedded MATLAB Function5' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction4_h;/* '<S29>/Embedded MATLAB Function4' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction3_k;/* '<S29>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction2_p;/* '<S29>/Embedded MATLAB Function2' */
  B_EmbeddedMATLABFunction_Cont_T sf_EmbeddedMATLABFunction1_c;/* '<S29>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction_a;/* '<S29>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction3_ps;/* '<S28>/Embedded MATLAB Function3' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction1_j;/* '<S28>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Co_o_T sf_EmbeddedMATLABFunction_b;/* '<S28>/Embedded MATLAB Function' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction2_h;/* '<S27>/Embedded MATLAB Function2' */
  B_EmbeddedMATLABFunction1_Con_T sf_EmbeddedMATLABFunction1_e;/* '<S27>/Embedded MATLAB Function1' */
  B_EmbeddedMATLABFunction_Cont_T sf_EmbeddedMATLABFunction_l;/* '<S27>/Embedded MATLAB Function' */
} B_Control_software_v1_1_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T Delay_DSTATE;                 /* '<S8>/Delay' */
  real_T Delay3_DSTATE;                /* '<S89>/Delay3' */
  real_T Delay1_DSTATE;                /* '<S89>/Delay1' */
  real_T Delay4_DSTATE;                /* '<S89>/Delay4' */
  real_T Delay_DSTATE_p;               /* '<S88>/Delay' */
  real_T DiscreteTransferFcn1_states[2];/* '<S9>/Discrete Transfer Fcn1' */
  real_T Delay_DSTATE_p2;              /* '<S92>/Delay' */
  real_T Delay1_DSTATE_b;              /* '<S92>/Delay1' */
  real_T Delay2_DSTATE;                /* '<S89>/Delay2' */
  real_T Delay_DSTATE_i;               /* '<S90>/Delay' */
  real_T Delay1_DSTATE_n;              /* '<S90>/Delay1' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_a;                 /* '<S85>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_k;                 /* '<S84>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_kg;                /* '<S81>/S-Function' */
...
struct P_Control_software_v1_1_T_ {
  ...
  real_T Gain_Gain_f;                  /* Expression: -1
                                        ...
                                        */
  real_T PNMSetup1_P1_Size[2];         /* Computed Parameter: PNMSetup1_P1_Size
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P1;                 /* Expression: id
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P2_Size[2];         /* Computed Parameter: PNMSetup1_P2_Size
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P2;                 /* Expression: driveLetter
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P3_Size[2];         /* Computed Parameter: PNMSetup1_P3_Size
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P3;                 /* Expression: configurationMode
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P4_Size[2];         /* Computed Parameter: PNMSetup1_P4_Size
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P4;                 /* Expression: mode
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P5_Size[2];         /* Computed Parameter: PNMSetup1_P5_Size
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P5;                 /* Expression: sampleTime
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P6_Size[2];         /* Computed Parameter: PNMSetup1_P6_Size
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P6[2];              /* Expression: pciSlot
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P7_Size[2];         /* Computed Parameter: PNMSetup1_P7_Size
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  real_T PNMSetup1_P7;                 /* Expression: quantityOfAcyclicObjects
                                        * Referenced by: '<S5>/PNM Setup1'
                                        */
  ...
  real_T Delay1_InitialCondition_n;    /* Expression: 0
                                        ...
                                        */
  real_T konstanteAusrollgeschw1_Value;/* Expression: 0.5
  ...
  real_T Delay1_InitialCondition_a;    /* Expression: 0
                                        ...
                                        */
  real_T Umrechnung1_Gain;             /* Expression: 0.1
                                        * Referenced by: '<S7>/Umrechnung1'
                                        */
  real_T Umrechnung_Gain;              /* Expression: 0.01
                                        * Referenced by: '<S7>/Umrechnung'
                                        */
  real_T SpoolingGrenze_Value;         /* Expression: 500
  ...
  real_T Gain1_Gain_a;                 /* Expression: 2
                                        ...
                                        */
  real_T PNMSend1_P1_Size[2];          /* Computed Parameter: PNMSend1_P1_Size
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMSend1_P1;                  /* Expression: id
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMSend1_P2_Size[2];          /* Computed Parameter: PNMSend1_P2_Size
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMSend1_P2;                  /* Expression: portType
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMSend1_P3_Size[2];          /* Computed Parameter: PNMSend1_P3_Size
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMSend1_P3;                  /* Expression: inputOutput
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMSend1_P4_Size[2];          /* Computed Parameter: PNMSend1_P4_Size
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMSend1_P4;                  /* Expression: sampleTime
                                        * Referenced by: '<S5>/PNM Send1'
                                        */
  real_T PNMReceive_P1_Size[2];        /* Computed Parameter: PNMReceive_P1_Size
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  real_T PNMReceive_P1;                /* Expression: id
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  real_T PNMReceive_P2_Size[2];        /* Computed Parameter: PNMReceive_P2_Size
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  real_T PNMReceive_P2;                /* Expression: portType
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  real_T PNMReceive_P3_Size[2];        /* Computed Parameter: PNMReceive_P3_Size
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  real_T PNMReceive_P3;                /* Expression: inputOutput
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  real_T PNMReceive_P4_Size[2];        /* Computed Parameter: PNMReceive_P4_Size
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  real_T PNMReceive_P4;                /* Expression: sampleTime
                                        * Referenced by: '<S5>/PNM Receive'
                                        */
  ...
  real_T DiscreteTransferFcn_InitialSt_m;/* Expression: 0
                                          * Referenced by: '<S13>/Discrete Transfer Fcn'
                                          */
  real_T Switch_Threshold_ha;          /* Expression: 0.5
...
struct tag_RTM_Control_software_v1_1_T {
  ...
  struct {
    ...
    SimStruct childSFunctions[50];
    SimStruct *childSFunctionPtrs[50];
    struct _ssBlkInfo2 blkInfo2[50];
    struct _ssSFcnModelMethods2 methods2[50];
    struct _ssSFcnModelMethods3 methods3[50];
    struct _ssSFcnModelMethods4 methods4[50];
    struct _ssStatesInfo2 statesInfo2[50];
    ssPeriodicStatesInfo periodicStatesInfo[50];
    struct {
      time_T sfcnPeriod[1];
      time_T sfcnOffset[1];
      int_T sfcnTsMap[1];
 ...
 * '<S2>'   : 'Control_software_v1_1/Input conditioning and estimators'
 * '<S3>'   : 'Control_software_v1_1/Inputs'
 * '<S4>'   : 'Control_software_v1_1/Logging'
 * '<S5>'   : 'Control_software_v1_1/Outputs'
 * '<S6>'   : 'Control_software_v1_1/Spooling_Pos_Controlled'
 * '<S7>'   : 'Control_software_v1_1/Spooling_Speed_Controlled'
 * '<S8>'   : 'Control_software_v1_1/Winch_Conrtol'
 ...
 * '<S12>'  : 'Control_software_v1_1/Input conditioning and estimators/Subsystem1/Subsystem'
 * '<S13>'  : 'Control_software_v1_1/Input conditioning and estimators/Subsystem1/Subsystem2'
 * '<S14>'  : 'Control_software_v1_1/Inputs/Analog Inputs'
 * '<S15>'  : 'Control_software_v1_1/Inputs/Digital Inputs'
 * '<S16>'  : 'Control_software_v1_1/Inputs/RS232_read'
 * '<S17>'  : 'Control_software_v1_1/Inputs/RS232_read/Compass_read'
 * '<S18>'  : 'Control_software_v1_1/Inputs/RS232_read/GPS_read'
 * '<S19>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read'
 * '<S20>'  : 'Control_software_v1_1/Inputs/RS232_read/QSC-100 F'
 * '<S21>'  : 'Control_software_v1_1/Inputs/RS232_read/Compass_read/Embedded MATLAB Function'
 * '<S22>'  : 'Control_software_v1_1/Inputs/RS232_read/GPS_read/Embedded MATLAB Function'
 * '<S23>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/Data_Check_CRC'
 * '<S24>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/Data_validation'
 * '<S25>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert'
 * '<S26>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/Data_Check_CRC/Embedded MATLAB Function'
 * '<S27>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem1'
 * '<S28>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem10'
 * '<S29>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12'
 * '<S30>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem14'
 * '<S31>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem15'
 * '<S32>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem16'
 * '<S33>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem17'
 * '<S34>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem18'
 * '<S35>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem19'
 * '<S36>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem6'
 * '<S37>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem8'
 * '<S38>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem9'
 * '<S39>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem1/Embedded MATLAB Function'
 * '<S40>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem1/Embedded MATLAB Function1'
 * '<S41>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem1/Embedded MATLAB Function2'
 * '<S42>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem10/Embedded MATLAB Function'
 * '<S43>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem10/Embedded MATLAB Function1'
 * '<S44>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem10/Embedded MATLAB Function3'
 * '<S45>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12/Embedded MATLAB Function'
 * '<S46>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12/Embedded MATLAB Function1'
 * '<S47>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12/Embedded MATLAB Function2'
 * '<S48>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12/Embedded MATLAB Function3'
 * '<S49>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12/Embedded MATLAB Function4'
 * '<S50>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12/Embedded MATLAB Function5'
 * '<S51>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem12/Embedded MATLAB Function6'
 * '<S52>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem14/Embedded MATLAB Function'
 * '<S53>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem15/Embedded MATLAB Function1'
 * '<S54>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem15/Embedded MATLAB Function2'
 * '<S55>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem15/Embedded MATLAB Function3'
 * '<S56>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem16/Embedded MATLAB Function1'
 * '<S57>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem16/Embedded MATLAB Function2'
 * '<S58>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem16/Embedded MATLAB Function3'
 * '<S59>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem16/Embedded MATLAB Function4'
 * '<S60>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem17/Embedded MATLAB Function2'
 * '<S61>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem18/Embedded MATLAB Function'
 * '<S62>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem18/Embedded MATLAB Function1'
 * '<S63>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem18/Embedded MATLAB Function2'
 * '<S64>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem19/Embedded MATLAB Function'
 * '<S65>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem19/Embedded MATLAB Function1'
 * '<S66>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem19/Embedded MATLAB Function3'
 * '<S67>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem6/Embedded MATLAB Function'
 * '<S68>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem6/Embedded MATLAB Function1'
 * '<S69>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem6/Embedded MATLAB Function3'
 * '<S70>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem6/Embedded MATLAB Function4'
 * '<S71>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem8/Embedded MATLAB Function'
 * '<S72>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem8/Embedded MATLAB Function1'
 * '<S73>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem8/Embedded MATLAB Function3'
 * '<S74>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem9/Embedded MATLAB Function'
 * '<S75>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem9/Embedded MATLAB Function1'
 * '<S76>'  : 'Control_software_v1_1/Inputs/RS232_read/IMU_read/IMU_data_convert/Subsystem9/Embedded MATLAB Function3'
 * '<S77>'  : 'Control_software_v1_1/Inputs/RS232_read/QSC-100 F/RS232 ISR'
 * '<S78>'  : 'Control_software_v1_1/Inputs/RS232_read/QSC-100 F/RS232 ISR/While Iterator Subsystem'
 * '<S79>'  : 'Control_software_v1_1/Logging/Log_conditioning'
 * '<S80>'  : 'Control_software_v1_1/Logging/MavLink_log'
 * '<S81>'  : 'Control_software_v1_1/Logging/TS100_log'
 * '<S82>'  : 'Control_software_v1_1/Logging/TS1_log'
 * '<S83>'  : 'Control_software_v1_1/Logging/Time_Scope_trigger'
 * '<S84>'  : 'Control_software_v1_1/Logging/Time_log'
 * '<S85>'  : 'Control_software_v1_1/Outputs/Scope (xPC) 1'
 * '<S86>'  : 'Control_software_v1_1/Outputs/Scope (xPC) 5'
 * '<S87>'  : 'Control_software_v1_1/Winch_Conrtol/Emergency'
 * '<S88>'  : 'Control_software_v1_1/Winch_Conrtol/Joystick Regelung1'
 * '<S89>'  : 'Control_software_v1_1/Winch_Conrtol/Subsystem'
 * '<S90>'  : 'Control_software_v1_1/Winch_Conrtol/damper'
 * '<S91>'  : 'Control_software_v1_1/Winch_Conrtol/Joystick Regelung1/Joystick-Steuerung'
 * '<S92>'  : 'Control_software_v1_1/Winch_Conrtol/Joystick Regelung1/damper'
 * '<S93>'  : 'Control_software_v1_1/Winch_Conrtol/Joystick Regelung1/damper/Compare To Zero'
 * '<S94>'  : 'Control_software_v1_1/Winch_Conrtol/Joystick Regelung1/damper/Compare To Zero1'
 * '<S95>'  : 'Control_software_v1_1/Winch_Conrtol/damper/Compare To Zero'
 * '<S96>'  : 'Control_software_v1_1/Winch_Conrtol/damper/Compare To Zero1'
 */
